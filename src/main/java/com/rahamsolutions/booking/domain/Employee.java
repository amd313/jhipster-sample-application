...
public class Employee implements Serializable {
    ...
    public Employee bookable(Boolean bookable) {
    ...
    public Employee services(Set<Service> services) {
        this.services = services;
        return this;
    }

    public Employee addService(Service service) {
        this.services.add(service);
        service.getEmployees().add(this);
        return this;
    }

    public Employee removeService(Service service) {
