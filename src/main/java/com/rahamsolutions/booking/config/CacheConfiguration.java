package com.rahamsolutions.booking.config;
...
public class CacheConfiguration {
    ...
    public JCacheManagerCustomizer cacheManagerCustomizer() {
        return cm -> {
            createCache(cm, com.rahamsolutions.booking.repository.UserRepository.USERS_BY_LOGIN_CACHE);
            createCache(cm, com.rahamsolutions.booking.repository.UserRepository.USERS_BY_EMAIL_CACHE);
