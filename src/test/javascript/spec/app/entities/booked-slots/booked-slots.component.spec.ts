...
import { BookedSlotsComponent } from 'app/entities/booked-slots/booked-slots.component';
...
describe('Component Tests', () => {
  describe('BookedSlots Management Component', () => {
    let comp: BookedSlotsComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(BookedSlotsComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.bookedSlots && comp.bookedSlots[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
